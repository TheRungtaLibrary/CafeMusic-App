 ...
 * 
 * HoloCircleSeekBar - Copyright 2012 Jes�ｽs Manzano
...
public class CircularSeekBar extends View implements OnSeekBarChangeListener{
	...
	private static final int DEFAULT_CIRCLE_PROGRESS_COLOR = Color.argb(235, 255, 165, 0);
	...
	public boolean onTouchEvent(MotionEvent event) {
		...
		case MotionEvent.ACTION_DOWN:
			...
			if (cwDistanceFromStart > mTotalCircleDegrees) {
				...
				WidgetHandler.barHandler.removeCallbacks(WidgetHandler.barUpdateTime);
		...
		case MotionEvent.ACTION_UP:
			...
			mPointerHaloPaint.setAlpha(mPointerAlpha);
			if (mUserIsMovingPointer) {
				Log.d("mOnCircularSeekBarChangeListener : ","...................................NOT NULL");
				mUserIsMovingPointer = false;
				invalidate();
				if (mOnCircularSeekBarChangeListener != null) {
					mOnCircularSeekBarChangeListener.onProgressChanged(this, mProgress, true);
				...
				WidgetHandler.barHandler.removeCallbacks(WidgetHandler.barUpdateTime);
				int totalTimeOfCurrentSong = WidgetHandler.mp.getDuration();
				SongDurationHandler SongDurationHandlerObject = new SongDurationHandler();
				int seekEndTime = SongDurationHandlerObject.progressToTimer(WidgetHandler.barSongDuration.getProgress(), totalTimeOfCurrentSong );
				WidgetHandler.mp.seekTo(seekEndTime);
				
				WidgetHandler.barHandler.postDelayed(WidgetHandler.barUpdateTime,1000);
			} else {
				return false;
			}
			break;
		case MotionEvent.ACTION_CANCEL: // Used when the parent view intercepts touches for things like scrolling
			Log.d("event.getAction() : ","...................................ACTION_CANCEL");
			mPointerHaloPaint.setAlpha(mPointerAlpha);
			mUserIsMovingPointer = false;
			invalidate();
			break;
