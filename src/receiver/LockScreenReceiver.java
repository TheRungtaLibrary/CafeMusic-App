...
public class LockScreenReceiver extends BroadcastReceiver  {
	...
	public void onReceive(Context context, Intent intent) {
        ...
        if (intent.getAction().equals(Intent.ACTION_SCREEN_OFF)) {
        	...
        	/*if(HomeScreen.intentLockScreen != null){
            	wasScreenOn=false;
            	Log.d("ACTION_SCREEN_OFF :::::::::::::::::::::::","::::::::::::: "+wasScreenOn);
        	...
        	wasScreenOn=true;
        	Log.d("ACTION_SCREEN_ON :::::::::::::::::::::::","::::::::::::: "+wasScreenOn);
        	if(HomeScreen.isAlreadyLocked == false){
	        	Intent intent11 = new Intent(context,LockScreenAppActivity.class);
	        	intent11.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
	        	context.startActivity(intent11);
	        	HomeScreen.isAlreadyLocked = true;
        	}
        	//context.startActivity(intent11);
